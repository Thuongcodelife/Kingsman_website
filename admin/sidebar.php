...
<!-- <div class="tablet mobile only row">
    <div id="mobiletabletsidebar" class="mobiletabletsidebar hidden">
        <div class="ui left fixed vertical menu scrollable">
            <div class="item">
                <table>
                    <tr>
                        <td>
                            <img class="ui mini image" src="images/user.png">
                        </td>
                        <td>
...
<!-- <a class="item"><i class="settings icon"></i> Settings</a>
            ...
            <div class="item" id="hidemobiletabletsidebar">
                <button class="fluid ui button" onclick="closeNavigation()">
                    Close
                </button>
            </div>
        </div>
